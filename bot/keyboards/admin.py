...
def plan_detail_kb(plan_id: int, is_active: bool) -> InlineKeyboardMarkup:
    ...
    builder.button(text="RAM", callback_data=f"admin:plan_edit:{plan_id}:ram")
    builder.button(text="CPU", callback_data=f"admin:plan_edit:{plan_id}:cpu")
    builder.button(text="Disk", callback_data=f"admin:plan_edit:{plan_id}:disk")
    builder.button(text="Bandwidth", callback_data=f"admin:plan_edit:{plan_id}:bandwidth")
    builder.button(text="موقعیت", callback_data=f"admin:plan_edit:{plan_id}:location")
    builder.button(text="دسته‌بندی", callback_data=f"admin:plan_edit:{plan_id}:category")
