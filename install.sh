...
# ── DB schema ─────────────────────────────────────────────────
# Schema is created automatically by the bot on first startup
# (Base.metadata.create_all) — no alembic migration step needed.
...
echo ""
echo "    nano $ENV_FILE && systemctl restart abrpardaz-bot abrpardaz-worker abrpardaz-beat"
echo ""
echo "  Useful commands:"
