...
class ServerService:
    ...
    async def create_server(
        ...
        if plan.provider_type == ProviderType.HETZNER:
            ...
            # جیکور تک-اکانتی است — همان اکانت فعال، با گاردِ لیمیت VM دستی
        ...
        elif plan.provider_type == ProviderType.ROOTVDS:
        ...
        server = Server(
            ...
            # bandwidth=0 یعنی ترافیک نامحدود (جیکور) → لیمیت None ذخیره می‌شود؛
